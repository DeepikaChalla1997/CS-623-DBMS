...
public class Connect {
	...
	ClassNotFoundException {
		...
		// Postgresql driver
				...
				//CASCADE is used in postgres view of maintaining integrity and consistency
				//stmt.executeUpdate("ALTER table stock add constraint fk_product foreign key(prodid) references product(prodid) on delete cascade on update cascade;");
				//stmt.executeUpdate("ALTER table stock add constraint fk_depot foreign key(depid) references depot(depid) on delete cascade on update cascade;");
